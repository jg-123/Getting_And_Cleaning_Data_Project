...
4) Renames data columns to values that make sense:
  ...
  * X data - finds corresponding feature names from "features.txt" and sets these as the column names for the reduced X test/train feature data (mean and std columns), removing parentheses, commas and converting all characters to lowercase
...
* **"fbodyacc-mean-x"** - mean of frequency domain (FFT) body acceleration in the x direction
* **"fbodyacc-mean-y"** - mean of frequency domain (FFT) body acceleration in the y direction
* **"fbodyacc-mean-z"** - mean of frequency domain (FFT) body acceleration in the z direction
* **"fbodyacc-std-x"** - standard deviation of frequency domain (FFT) body acceleration in the x direction
* **"fbodyacc-std-y"** - standard deviation of frequency domain (FFT) body acceleration in the y direction
* **"fbodyacc-std-z"** - standard deviation of frequency domain (FFT) body acceleration in the z direction
...
* **"fbodyaccjerk-mean-x"** - mean of frequency domain (FFT) body acceleration jerk in the x direction
* **"fbodyaccjerk-mean-y"** - mean of frequency domain (FFT) body acceleration jerk in the x direction
* **"fbodyaccjerk-mean-z"** - mean of frequency domain (FFT) body acceleration jerk in the x direction
* **"fbodyaccjerk-std-x"** - standard deviation of frequency domain (FFT) body acceleration jerk in the x direction
* **"fbodyaccjerk-std-y"** - standard deviation of frequency domain (FFT) body acceleration jerk in the y direction
* **"fbodyaccjerk-std-z"** - standard deviation of frequency domain (FFT) body acceleration jerk in the z direction
...
* **"fbodygyro-mean-x"** - mean of frequency domain (FFT) body gyroscope in the x direction
* **"fbodygyro-mean-y"** - mean of frequency domain (FFT) body gyroscope in the y direction
* **"fbodygyro-mean-z"** - mean of frequency domain (FFT) body gyroscope in the z direction
* **"fbodygyro-std-x"** - standard deviation of frequency domain (FFT) body gyroscope in the x direction
* **"fbodygyro-std-y"** - standard deviation of frequency domain (FFT) body gyroscope in the y direction
* **"fbodygyro-std-z"** - standard deviation of frequency domain (FFT) body gyroscope in the z direction
...
* **"fbodyaccmag-mean"** - mean of frequency domain (FFT) body acceleration total magnitude
* **"fbodyaccmag-std"** - standard deviation of frequency domain (FFT) body acceleration total magnitude
...
* **"fbodybodyaccjerkmag-mean"** - mean of frequency domain (FFT) body acceleration jerk total magnitude
* **"fbodybodyaccjerkmag-std"** - standard deviation of frequency domain (FFT) body acceleration jerk total magnitude
...
* **"fbodybodygyromag-mean"** - mean of frequency domain (FFT) body gyroscope total magnitude
* **"fbodybodygyromag-std"** - standard deviation of frequency domain (FFT) body gyroscope total magnitude
...
* **"fbodybodygyrojerkmag-mean"** - mean of frequency domain (FFT) body gyroscope jerk total magnitude
* **"fbodybodygyrojerkmag-std"** - standard deviation of frequency domain (FFT) body gyroscope jerk total magnitude
